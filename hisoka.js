/**
   ...
   * Contact Me on wa.me/6283181106073
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: '#' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6283181106073 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://paypal.me/samuelesoputra1 Saweria : https://saweria.co/salsa234` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Script : https://github.com/DikaArdnt/Hisoka-Morou\n\n Dont Forget Give Star\n\nDonate : 6283181106073 (Dana)\nSaweria : https://saweria.co/salsa234\nPaypal : https://www.paypal.me/samuelesoputra1\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
	    ...
	    case 'setname': case 'setsubject': {
          ...
          case 'setppbot': {
           ...
           case 'setppgroup': case 'setppgrup': case 'setppgc': {
            ...
            case 'tagall': {
                if (!m.isGroup) throw mess.group
                if (!isCreator) throw mess.creator
let teks = `══✪〘 *👥 Tag All* 〙✪══
